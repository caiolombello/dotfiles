...
PLASMA6MACOS_install_dependencies() {
    sudo zypper install -y libqt5-qttools curl wget rsync git nautilus gnome-terminal nautilus-extension-terminal sassc kdeconnect-kde
}

# Function to install GNOME apps
PLASMA6MACOS_install_gnome_apps() {
    sudo zypper install -y gnome-weather gnome-maps gnome-calendar gnome-clocks vlc
}
...
PLASMA6MACOS_enable_flatpak_appimage() {
    sudo zypper install -y flatpak fuse
    sudo flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo
}

# Install Flatpak applications
PLASMA6MACOS_install_flatpak_apps() {
    sudo flatpak install -y flathub io.bassi.Amberol #com.mattjakeman.ExtensionManager com.github.KRTirtho.Spotube
...
PLASMA6MACOS_install_kvantum_manager() {
    sudo zypper install -y kvantum-manager
...
PLASMA6MACOS_install_albert() {
    sudo zypper --gpg-auto-import-keys addrepo https://download.opensuse.org/repositories/home:manuelschneid3r/openSUSE_Tumbleweed/home:manuelschneid3r.repo    sudo zypper refresh
    sudo zypper --gpg-auto-import-keys refresh
    sudo zypper install -y albert
...
clear
echo "===================================================================="
echo " Auto Customize KDE Plasma 6 Look Like macoS on openSUSE Tumbleweed "
echo "===================================================================="
