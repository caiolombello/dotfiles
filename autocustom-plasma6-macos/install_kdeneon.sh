#!/bin/bash
#
# Script Name: install_kdeneon.sh
# Version : 2.0
...
PLASMA6MACOS_install_gnome_apps() {
    sudo apt install -y gnome-weather gnome-maps gnome-calendar gnome-clocks vlc
}
...
PLASMA6MACOS_enable_flatpak_appimage() {
    sudo apt install -y flatpak libfuse2
...
PLASMA6MACOS_install_kvantum_manager() {
    ...
    sudo apt update
    sudo apt install -y qt6-style-kvantum -y
...
PLASMA6MACOS_install_plymouth() {
    ...
    sudo update-alternatives --install /usr/share/plymouth/themes/default.plymouth default.plymouth /usr/share/plymouth/themes/macOS/macOS.plymouth 101
    sudo ln -sf /usr/share/plymouth/themes/macOS/macOS.plymouth /etc/alternatives/default.plymouth
...
clear
echo "============================================================="
echo " Auto Customize KDE Plasma 6 Look Like macoS on KDE Neon     "
echo "============================================================="
